 ...
 * @author nha36
 */
@WebFilter(filterName = "AuthenticationFillter", urlPatterns = {"/*"})
public class AuthenticationFillter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("AuthenticationFillter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthenticationFillter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("AuthenticationFillter:doFilter()");
        }
        ...
        try {
            ...
            Boolean isAdminUrl = (tmp[tmp.length - 1].equalsIgnoreCase("addAccount.jsp")
                            || tmp[tmp.length - 1].equalsIgnoreCase("updateAccount.jsp")
                            || tmp[tmp.length - 1].equalsIgnoreCase("deleteAccount.jsp")
                            || tmp[tmp.length - 1].equalsIgnoreCase("listOfAccount.jsp"));
            if (req.getRequestURI().indexOf("private") > 0) {
                HttpSession session = req.getSession();
                AccountDTO account = (AccountDTO) session.getAttribute("tt");
                if (account == null) {
                    res.sendRedirect(req.getContextPath() + "/view/login.jsp");
                } else {
                    if (account.getRoleInSystem() != 1 && isAdminUrl) {
                        res.sendRedirect(req.getContextPath() + "/view/home.jsp");
                    }
                }
            }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AuthenticationFillter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AuthenticationFillter()");
        }
        StringBuffer sb = new StringBuffer("AuthenticationFillter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("AuthenticationFillter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("AuthenticationFillter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("AuthenticationFillter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("AuthenticationFillter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("AuthenticationFillter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
