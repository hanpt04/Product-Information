<%-- 
    Document   : addAccount
    Created on : Oct 11, 2024, 1:43:30 PM
    Author     : nha36
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid main"  >
            ...
            <form action="<%=request.getContextPath()%>/add" method="POST" class="form-horizontal content">
                ...
                <%
                String mess = (String)session.getAttribute("mess error");
                if(mess!=null){
                    out.println(mess);
                }
                %>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9 button">
